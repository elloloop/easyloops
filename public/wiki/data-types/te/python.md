...
Data types ante variables lo store cheyagala data type and ela manipulate cheyalo define chesthundi. Idi programming lo foundation la work chesthundi, operations and memory allocation decide chesthundi.

“Naa love story program laga perfect ga run avuthundi!”

## Primitive Data Types

### 1. Integer (int)

Integer means purthi numbers laga age, count.
...
Floating-point means decimal values laga height, price.
...
String means words or sentences laga text.
...
Character means oka letter or symbol.
...
Lists mean items sequence laga store cheyadam.
...
Dictionaries or maps ante key tho value link cheyadam.
...
Sets ante no duplicate items collection.
...
Implicit conversion ante types automatic ga convert avuthundi.

“Naa marks automatic ga rank ga convert ayipoyayi!”
...
Explicit conversion ante type ni direct ga convert cheyadam.

“Naa rank string nunchi number ga convert chesa!”
