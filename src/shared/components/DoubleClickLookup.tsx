...
const wordToSlugs: Record<string, string[]> = {
  ...
  probability: ['probability-foundations', 'conditional-probability', 'ml-math-roadmap'],
  conditional: ['conditional-probability', 'conditional-expectation'],
  bayes: ['conditional-probability'],
  bayesian: ['conditional-probability'],
  random: ['random-variables'],
  expectation: ['expectation', 'conditional-expectation'],
  expected: ['expectation', 'conditional-expectation'],
  regression: ['conditional-expectation', 'linear-regression', 'logistic-regression'],
  prediction: ['conditional-expectation'],
  variance: ['variance'],
  covariance: ['covariance-and-independence'],
  independent: ['covariance-and-independence'],
  independence: ['covariance-and-independence'],
  distribution: ['basic-distributions'],
  distributions: ['basic-distributions'],
  bernoulli: ['basic-distributions'],
  binomial: ['basic-distributions'],
  categorical: ['basic-distributions'],
  gaussian: ['basic-distributions'],
  normal: ['basic-distributions'],
  gradient: ['multivariable-calculus', 'optimization-gradient-descent'],
  partial: ['multivariable-calculus'],
  derivative: ['multivariable-calculus'],
  jacobian: ['multivariable-calculus'],
  calculus: ['multivariable-calculus'],
  descent: ['optimization-gradient-descent'],
  sgd: ['optimization-gradient-descent'],
  loss: ['optimization-gradient-descent'],
  convex: ['optimization-gradient-descent'],
  convexity: ['optimization-gradient-descent'],
  mse: ['linear-regression'],
  sigmoid: ['logistic-regression'],
  softmax: ['logistic-regression'],
  crossentropy: ['logistic-regression'],
  ...
  batch: ['batching-and-memory'],
  batching: ['batching-and-memory'],
  vram: ['batching-and-memory'],
  parameters: ['batching-and-memory', 'optimization-gradient-descent'],
